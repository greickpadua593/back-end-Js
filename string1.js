...
//ex7
let frase1 = "Aprender a programar é incrível";
let posicao1=frase1.charAt[100]
console.log(posicao1)

//ex8
let nome1=" Ana Maria Silva ";
let novoNome1=nome1.trim()
let qtde=novoNome1.length
console.log("o nome limpo tem", qtde, "caracteres")
console.log(`O nome limpo tem ${qtde} caracteres`)
...
let texto1= "a"
console.log(texto1.charCodeAt())

//ex10
let frase2 = " Código Seguro 🔒 ";
console.log(frase2.length)
let fraselimpa=frase2.trim()
console.log(fraselimpa.charAt(0))
let posicao2=fraselimpa.indexOf("🔒")
console.log(fraselimpa.codePointAt(posicao2))